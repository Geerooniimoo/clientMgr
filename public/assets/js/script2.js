...
container.innerHTML = `
    <div id="newClientDiv" class="row">
        <div id="summary">
            ...
            <span id="activeClients">${data.map(({tutored})=>tutored.map(({hours})=>hours).reduce((a,b)=>a+b)).reduce((a,b)=>a+b)}
            </span>
            <label for="activeClients">Active Clients</label>
            <span id="activeClients">-1</span>
            <label for="remainHours">Hours Remaining</label>
            <span id="remainHours">-1</span>
        </div>
    </div>
    <table id="table">
        <thead>
